...
1. feleves3_C#:
- This was my first project as a Computer Science student. It was a given as a semester assignment.
- It is a 'How to be a Millionaire' quiz game C# Console Application.
- It showcases basic OOP (class, interface, inheritance, polymorphism), data types, user input and file handling.

2. ToDoApp_ ASP.NET:
- This project is my implementation of the good old 'ToDo App'.
